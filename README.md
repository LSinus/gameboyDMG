...
and audio emulation. Furthermore, there are still some minor rendering issues in some games.
...
all the features required in order to run correctly that game.
